       ...
       {topPicks.map((item)=>(
            <div className='bg-[white] rounded-md'key={item.id}>
              ...
              <div className='flex flex-col justify-center items-center gap-2 p-4'>
                ...
                {/* <button className='bg-black  w-[100px] text-white rounded-md my-6 py-[10px] hover:text-[#fbc531] font-semibold' onClick={handelAdd}  > Add to cart</button> */}
              </div>
            </div>
        ))}
         </Slider>
